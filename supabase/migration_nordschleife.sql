...
VALUES (
  ...
  'Je gratis 5 pogingen op de Nordschleife trivia time-trial zitten erop. Met dit pakket krijg je er 5 extra. De credits worden direct na betaling toegekend aan dit apparaat (cookie, 30 dagen geldig).',
  'Nordschleife — 5 Extra Laps',
  '5 more shots at the Green Hell',
  'Your 5 free laps on the Nordschleife trivia time-trial are gone. This pack adds 5 more. Credits are issued to this device immediately after payment (cookie, valid for 30 days).',
