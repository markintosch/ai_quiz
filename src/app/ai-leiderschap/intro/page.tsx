    ...
    <div className="ail-root">
      ...
      <header className="ail-hero">
        <div className="ail-wrap">
          ...
          <p className="ail-meta">{c.duration}</p>
      ...
      <section className="ail-sec ail-alt">
        <div className="ail-wrap ail-narrow">
          <h2>{c.topicsHeading}</h2>
          <p className="ail-muted">{c.topicsIntro}</p>
          <ul className="ail-topics">
      ...
      <section className="ail-sec ail-cta-sec">
        <div className="ail-wrap ail-narrow ail-center">
          <h2>{c.ctaHeading}</h2>
          <p className="ail-muted">{c.duration}</p>
          ...
          <p className="ail-note-light">{c.note}</p>
...
.ail-lead{font-size:19px;color:#b0c2d2;margin-top:18px!important;max-width:720px}
.ail-meta{font-size:14px;color:#9fb2c2;margin-top:12px!important}
...
.ail-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:18px;margin-top:28px}
.ail-card{background:#fff;border:1px solid var(--line);border-radius:14px;padding:22px}
.ail-card h3{margin-bottom:8px}
.ail-card p{color:var(--muted);font-size:15px}
.ail-topics{list-style:none;padding:0;margin-top:20px!important;display:grid;gap:12px}
.ail-topics li{font-size:16px;color:var(--ink);padding-left:24px;position:relative}
.ail-topics li::before{content:"";position:absolute;left:0;top:10px;width:14px;height:2px;background:var(--acc);border-radius:2px}
.ail-cta-sec{background:linear-gradient(180deg,#fff,#fff8f2)}
.ail-cta-row{margin:24px 0 18px}
.ail-note-light{font-size:14px;color:var(--muted);margin-top:8px!important}
...
@media(max-width:760px){.ail-grid{grid-template-columns:1fr}}
`
