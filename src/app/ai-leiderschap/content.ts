...
export const DEFAULT_CONTENT: AILContent = {
  ...
  problem: {
    ...
    body: 'Je organisatie experimenteert met AI — of weet dat het moet. Maar wat het écht vraagt van jou als leider blijft vaak ongezegd. Niet welke tool, maar welke beslissingen. Niet welke training, maar welke richting. Niet "AI doen", maar leiden in een tijd waarin AI je strategie, je team en je rol verandert.',
  },
  audience: {
  ...
  program: {
    ...
    items: [
      { title: 'Keynote — Ben van den Burg', body: 'Eén uur over wat AI verschuift in leiderschap. Geen hype, wel scherpe observaties uit de praktijk.' },
  ...
  trajectory: {
    heading: 'Niet één middag — een 90-dagen-traject',
    ...
    steps: [
      ...
      { label: 'Dag 30 / 60 / 90', title: 'Progressiemetingen', body: 'Drie korte gepersonaliseerde metingen op precies de mijlpalen van je canvas. Je krijgt je delta-rapport — zie waar je beweegt en waar niet.' },
  ...
  slots: {
    heading: 'Boek je plek — 29 juni 2026',
  ...
  waitlist: {
    ...
    intro: 'Schrijf je vrijblijvend voor — we plannen regelmatig een nieuwe editie. Voorinschrijvers worden als eerste uitgenodigd zodra de volgende datum vaststaat.',
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'Is de baseline-assessment verplicht?', a: 'Aanbevolen, niet verplicht. Wie vooraf invult haalt veel meer uit de cohort-spiegel en de werkblokken — dat zijn de momenten waarop de data van de zaal terugkomt.' },
