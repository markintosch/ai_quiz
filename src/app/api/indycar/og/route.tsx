// Dynamic Open Graph card for IndyCar lap-time shares.
...
const L = {
  ...
  green:        { en: 'Indy', de: 'Indy', nl: 'Indy', fr: 'Indy', es: 'Indy' },
  hell:         { en: '500',  de: '500',  nl: '500',  fr: '500',  es: '500' },
  trivia:       { en: 'Trivia.', de: 'Trivia.', nl: 'Trivia.', fr: 'Trivia.', es: 'Trivia.' },
  teaser_body:  { en: '30 questions about the Greatest Spectacle in Racing. Every second counts.', de: '30 Fragen über das größte Rennen der Welt. Jede Sekunde zählt.', nl: '30 vragen over The Greatest Spectacle in Racing. Elke seconde telt.', fr: '30 questions sur le Greatest Spectacle in Racing. Chaque seconde compte.', es: '30 preguntas sobre el Greatest Spectacle in Racing. Cada segundo cuenta.' },
  can_you_beat: { en: 'CAN YOU BEAT IT?', de: 'SCHAFFST DU DAS?', nl: 'KUN JIJ HET BETER?', fr: 'VOUS FAITES MIEUX ?', es: '¿PUEDES SUPERARLO?' },
  body_pitch:   { en: '30 trivia questions, one lap of the Brickyard.', de: '30 Trivia-Fragen, eine Runde Brickyard.', nl: '30 trivia-vragen, één ronde Brickyard.', fr: '30 questions de trivia, un tour du Brickyard.', es: '30 preguntas de trivia, una vuelta al Brickyard.' },
  ...
  cta:          { en: 'indy 500 trivia →', de: 'indy 500 trivia →', nl: 'indy 500 trivia →', fr: 'indy 500 trivia →', es: 'indy 500 trivia →' },
  green_hell:   { en: '🏁 INDY 500 · TIME TRIAL', de: '🏁 INDY 500 · ZEITFAHREN', nl: '🏁 INDY 500 · TIME TRIAL', fr: '🏁 INDY 500 · CONTRE-LA-MONTRE', es: '🏁 INDY 500 · CONTRARRELOJ' },
} as const
      ...
      >
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
            ...
            >
              <span style={{ fontSize: 32, fontWeight: 900, color: WHITE }}>I</span>
            </div>
