...
import { COOKIE_NAME, creditCookieOptions, decodeCreditCookie, encodeCreditCookie } from '@/lib/indycar/credits'
...
// POST — burn one paid credit (called by /indycar/play when starting a paid lap)
