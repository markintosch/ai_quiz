...
export default async function IntroTrainingPage({ params, searchParams }: PageProps) {
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8">
          <div className="mb-6">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mt-3 mb-2">
              Interested in an online introduction to AI?
            </h1>
            <p className="text-sm text-gray-600 leading-relaxed">
              We are preparing practical introduction sessions for individuals and groups who want to better
              understand AI, its opportunities, and how to apply it in real work contexts.
              Register your interest and we&apos;ll keep you informed about upcoming sessions.
            </p>
          </div>
