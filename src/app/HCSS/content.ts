...
export const DEFAULT_CONTENT: HcssContent = {
  ...
  assessment: {
    eyebrow: 'Gratis quickscan',
    heading: 'Weet binnen 10 minuten waar je staat',
    body: 'Doe de online cybersecurity-quickscan en krijg direct een eerste beeld van je digitale weerbaarheid. Geen verplichtingen — wel een helder vertrekpunt voor het gesprek.',
    bullets: [
      'Gebaseerd op ISO 27001 en NIST CSF',
      'Direct inzicht per domein',
      'Concrete eerste vervolgstappen',
    ],
    ctaLabel: 'Start de gratis quickscan',
    ctaHref: '#contact',
  ...
  testimonial: {
    quote: 'Diederik heeft enorm veel kennis op het gebied van Cyber Security. Hij is niet alleen een professional, maar ook een uitstekende luisteraar die altijd openstaat voor nieuwe ideeën.',
    author: 'Caty H. — klant van Diederik',
  },
  contact: {
