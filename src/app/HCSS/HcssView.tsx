  ...
  return (
    <div className="hcss-root">
      ...
      <section className="hcss-sec hcss-quote-sec">
        <div className="hcss-wrap hcss-narrow">
          <blockquote className="hcss-quote">“{c.testimonial.quote}”</blockquote>
          <p className="hcss-quote-author">— {c.testimonial.author}</p>
        </div>
      </section>
...
.hcss-quote{font-size:24px;font-weight:600;line-height:1.45;color:#eaf1f7}
.hcss-quote-author{margin-top:16px!important;color:var(--acc2);font-weight:600}
/* FOUNDER */
...
@media(max-width:880px){.hcss-grid4{grid-template-columns:1fr 1fr}.hcss-tiers{grid-template-columns:1fr}.hcss-contact-grid{grid-template-columns:1fr}.hcss-creds{grid-template-columns:1fr}.hcss-founder{flex-direction:column}}
