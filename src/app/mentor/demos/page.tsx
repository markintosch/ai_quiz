...
const PROJECTS = [
  ...
  },
  {
    ...
    method:    'Hot Lap',
    methodColor: '#E10600',
    title:     { nl: 'Cloud Knowledge Game — Hot Lap', en: 'Cloud Knowledge Game — Hot Lap' },
    body: {
      nl: 'Een getimede solo-kennisrace. Tien vragen op moeilijkheidsgraad, elke fout kost seconden. Wekelijks vernieuwd. Ingezet als sponsorplatform voor TrueFullstaq — de snelste en meest accurate speler wint. Founding sponsor-gesprekken lopen.',
      en: 'A timed solo knowledge race. Ten questions on difficulty, every wrong answer costs seconds. Refreshed weekly. Deployed as a sponsor platform for TrueFullstaq — fastest and most accurate player wins. Founding sponsor conversations in progress.',
    },
    pills: { nl: ['Leaderboard', 'Wekelijks', 'Sponsoring'], en: ['Leaderboard', 'Weekly', 'Sponsorship'] },
    demo: `${BASE}/vrooooom`,
  },
  {
    num:       '04',
    accent:    '#D97706',
    tag:       { nl: 'Live engagement · Evenementen', en: 'Live engagement · Events' },
    audience:  { nl: 'Conferenties, workshops, beurzen', en: 'Conferences, workshops, trade shows' },
    method:    'Arena',
    methodColor: '#D97706',
    title:     { nl: 'Live Arena', en: 'Live Arena' },
    body: {
      nl: 'Multiplayer quiz-engine voor evenementen. Deelnemers joinen met een QR-code of code, beantwoorden getimede vragen, zien een live scorebord bijwerken. De host stuurt het tempo. Real-time. Geschikt voor elk thema.',
      en: 'Multiplayer quiz engine for events. Participants join with a QR code or code, answer timed questions, watch a live leaderboard update. The host controls the pace. Real-time. Adaptable to any theme.',
    },
    pills: { nl: ['Real-time', 'QR join', 'Live scorebord', 'Host-gestuurd'], en: ['Real-time', 'QR join', 'Live leaderboard', 'Host-controlled'] },
