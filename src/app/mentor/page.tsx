...
const META: Record<Lang, {
  ...
  nl: {
    ...
    desc:     'Van AI-ambitie naar heldere richting, intern draagvlak en een eerste use case die werkt. Persoonlijke begeleiding voor senior leiders. Oprichter Brand PWRD Media. Max. 5 trajecten tegelijk.',
  ...
  en: {
    ...
    desc:     "From AI ambition to clear direction, internal buy-in and a first use case that actually works. Personal guidance for senior leaders. Founder of Brand PWRD Media. Max. 5 engagements at a time.",
  ...
  de: {
    ...
    desc:     'Von KI-Ambition zu klarer Richtung, internem Rückhalt und einem ersten funktionierenden Use Case. Persönliche Begleitung für Senior Leader. Gründer Brand PWRD Media. Max. 5 Engagements gleichzeitig.',
