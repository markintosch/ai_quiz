...
import { PAID_BUNDLE_ATTEMPTS, PAID_BUNDLE_PRICE_EUR, PAID_PRODUCT_SLUG } from '@/products/indycar/data'
...
export default function IndycarBuyPage() {
      ...
      <div style={{ maxWidth: 480, margin: '0 auto', padding: '48px 24px 80px' }}>
        ...
        <div style={{ fontSize: 12, color: MUTED, lineHeight: 1.6 }}>
          ...
          <p style={{ marginTop: 14 }}>
            <Link href="/indycar" style={{ color: GREEN, textDecoration: 'underline' }}>{t('buy_back')}</Link>
          </p>
        </div>
      </div>
    </div>
