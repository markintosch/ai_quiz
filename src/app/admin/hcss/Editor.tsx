  ...
  return (
    <div className="max-w-3xl">
      ...
      <Section title="Testimonial">
        <Field label="Quote" value={c.testimonial.quote} onChange={(v) => patch('testimonial', { quote: v })} textarea />
        <Field label="Auteur" value={c.testimonial.author} onChange={(v) => patch('testimonial', { author: v })} />
      </Section>
