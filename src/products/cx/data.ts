...
export function scoreColour(score: number): ScoreColour {
  if (score >= 3.5) return { bg: '#0EA5A0', text: '#fff', label: 'CX-Led',           labelNl: 'CX-gedreven',              pastelBg: '#E6F9F8' }
  if (score >= 2.5) return { bg: '#4B9FD6', text: '#fff', label: 'Customer-Centric', labelNl: 'Klantgericht',             pastelBg: '#EBF5FB' }
