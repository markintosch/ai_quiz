...
const EASY: LapQuestion[] = [
  ...
  { id: 'e19', difficulty: 'easy', topic: 'corners',
    text: 'Which village — with a medieval castle on the hilltop — sits inside the Nordschleife loop and gives the circuit its name?',
    options: [{ value: 'a', label: 'Nürburg' }, { value: 'b', label: 'Adenau' }, { value: 'c', label: 'Aachen' }, { value: 'd', label: 'Andernach' }],
    correct: 'a' },
  ...
  { id: 'e33', difficulty: 'easy', topic: 'history',
    text: 'During the Nordschleife\'s construction in the mid-1920s, the project employed approximately how many workers at its peak?',
...
const MEDIUM: LapQuestion[] = [
  ...
  { id: 'm19', difficulty: 'medium', topic: 'records',
    ...
    options: [{ value: 'a', label: '50' }, { value: 'b', label: '100' }, { value: 'c', label: 'Around 190' }, { value: 'd', label: 'Over 400' }],
    correct: 'c' },
  ...
  { id: 'm25', difficulty: 'medium', topic: 'corners',
    text: 'What is the approximate average width of the Nordschleife?',
    options: [{ value: 'a', label: '4 metres' }, { value: 'b', label: '8–9 metres' }, { value: 'c', label: '15 metres' }, { value: 'd', label: '25 metres' }],
    correct: 'b' },
  ...
  { id: 'm28', difficulty: 'medium', topic: 'records',
    text: 'Which Mercedes-AMG hypercar broke the production-car Nordschleife record at 6:29.090 in 2024?',
...
const HARD: LapQuestion[] = [
  ...
  { id: 'h05', difficulty: 'hard', topic: 'lauda',
    text: 'In his Ferrari 312T in 1975, Niki Lauda set what was then a stunning Nordschleife lap record of approximately…',
  ...
  { id: 'h07', difficulty: 'hard', topic: 'corners',
    ...
    options: [{ value: 'a', label: '7°' }, { value: 'b', label: '17°' }, { value: 'c', label: '32°' }, { value: 'd', label: '45°' }],
    correct: 'b' },
  ...
  { id: 'h18', difficulty: 'hard', topic: 'corners',
    text: 'Which fast downhill left-hand sweeper comes immediately after "Adenauer Forst"?',
  ...
  { id: 'h19', difficulty: 'hard', topic: 'records',
    text: 'Approximately how many lateral g-forces do GT3-class drivers experience through the original Karussell\'s concrete banking?',
    options: [{ value: 'a', label: '0.5 g' }, { value: 'b', label: 'About 2 g' }, { value: 'c', label: '3.5 g' }, { value: 'd', label: '5 g' }],
    correct: 'b' },
  ...
  { id: 'h26', difficulty: 'hard', topic: '24h',
    text: 'Which manufacturer scored overall 24h Nürburgring wins in 2018 and 2020 with its M6 GT3?',
  ...
  { id: 'h27', difficulty: 'hard', topic: 'manufacturers',
    text: 'Which production-EV brand set the Nordschleife production EV record of 7:25.231 in June 2023?',
