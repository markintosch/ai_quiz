...
const EASY: LapQuestion[] = [
  ...
  { id: 'e29', difficulty: 'easy', topic: 'traditions',
    text: 'What is left at IMS after every Indy 500 winner gets their face added to the trophy?',
...
const MEDIUM: LapQuestion[] = [
  ...
  { id: 'm34', difficulty: 'medium', topic: 'traditions',
    ...
    options: [{ value: 'a', label: 'Fat-free, 2%, whole or none' }, { value: 'b', label: 'Skim, soy, oat or none' }, { value: 'c', label: 'Whole, almond or coconut' }, { value: 'd', label: 'Only whole milk is offered' }],
    correct: 'a' },
