/**
 * IndyCar — 5-language UI strings + locale helpers.
 *
 * Locales: en (default) · de · nl · fr · es
 *
 * The user's choice is persisted in localStorage under
 * `indycar_locale`. On first visit we attempt to detect from
...
export const LOCALE_STORAGE_KEY = 'indycar_locale'
...
export const STR = {
  // ── Header / nav / banner ──
  header_subtitle:           { en: '🏁 INDY 500 · TIME TRIAL',                        de: '🏁 INDY 500 · ZEITFAHREN',                    nl: '🏁 INDY 500 · TIME TRIAL',                 fr: '🏁 INDY 500 · CONTRE-LA-MONTRE',            es: '🏁 INDY 500 · CONTRARRELOJ' },
  live_banner:               { en: '🏁 Race week: the 2026 INDIANAPOLIS 500 — warm up with Brickyard trivia',
                               de: '🏁 Rennwoche: das INDIANAPOLIS 500 2026 — wärm dich auf mit Brickyard-Trivia',
                               nl: '🏁 Race-week: de INDIANAPOLIS 500 2026 — warm op met Brickyard-trivia',
                               fr: '🏁 Semaine de course : les 500 MILES D\'INDIANAPOLIS 2026 — échauffement trivia au Brickyard',
                               es: '🏁 Semana de carrera: las 500 MILLAS DE INDIANÁPOLIS 2026 — calienta con trivia del Brickyard' },

  // ── Landing hero ──
  hero_kicker:               { en: '2.5 mi · 200 laps · 500 miles',                   de: '4,02 km · 200 Runden · 500 Meilen',           nl: '4,02 km · 200 ronden · 500 mijl',           fr: '4,02 km · 200 tours · 500 miles',           es: '4,02 km · 200 vueltas · 500 millas' },
  hero_title_part1:          { en: 'The',                                              de: 'Das',                                          nl: 'Het',                                       fr: 'Le',                                         es: 'El' },
  hero_title_green:          { en: 'Indy',                                             de: 'Indy',                                         nl: 'Indy',                                      fr: 'Indy',                                       es: 'Indy' },
  hero_title_hell:           { en: '500',                                              de: '500',                                          nl: '500',                                       fr: '500',                                        es: '500' },
  hero_title_suffix:         { en: 'Time Trial.',                                      de: 'Zeitfahren.',                                  nl: 'Time Trial.',                               fr: 'contre-la-montre.',                          es: 'contrarreloj.' },
  hero_body:                 { en: '30 trivia questions about the Greatest Spectacle in Racing. 15 seconds each. Wrong answer or timeout = +5 second penalty. Your total time is your lap time. Beat the Brickyard.',
                               de: '30 Trivia-Fragen über das größte Rennen der Welt. 15 Sekunden pro Frage. Falsche Antwort oder Timeout = +5 Sekunden Strafe. Deine Gesamtzeit ist deine Rundenzeit. Schlag den Brickyard.',
                               nl: '30 trivia-vragen over The Greatest Spectacle in Racing. 15 seconden per vraag. Fout antwoord of timeout = +5 seconden straf. Je totale tijd is je rondetijd. Versla de Brickyard.',
                               fr: '30 questions de trivia sur le Greatest Spectacle in Racing. 15 secondes par question. Mauvaise réponse ou timeout = +5 secondes de pénalité. Votre temps total est votre temps au tour. Battez le Brickyard.',
                               es: '30 preguntas de trivia sobre el Greatest Spectacle in Racing. 15 segundos por pregunta. Respuesta incorrecta o tiempo agotado = +5 segundos de penalización. Tu tiempo total es tu vuelta. Vence al Brickyard.' },
  ...
  rules_sect_b:              { en: 'Front Straight (easy) → Turn 1 (medium) → Yard of Bricks (hard).',
                               de: 'Front Straight (leicht) → Turn 1 (mittel) → Yard of Bricks (schwer).',
                               nl: 'Front Straight (makkelijk) → Turn 1 (gemiddeld) → Yard of Bricks (moeilijk).',
                               fr: 'Ligne droite (facile) → Virage 1 (moyen) → Yard of Bricks (difficile).',
                               es: 'Recta principal (fácil) → Curva 1 (medio) → Yard of Bricks (difícil).' },
  ...
  rules_pool_b:              { en: 'Every lap pulls 30 from a 100-question Indy 500 trivia bank.',
                               de: 'Jede Runde zieht 30 Fragen aus einem Pool von 100 Indy-500-Trivia.',
                               nl: 'Elke ronde trekt 30 vragen uit een pool van 100 Indy 500-trivia.',
                               fr: 'Chaque tour tire 30 questions parmi 100 sur l\'Indy 500.',
                               es: 'Cada vuelta saca 30 preguntas de un banco de 100 sobre la Indy 500.' },
  ...
  leaderboard_empty:         { en: 'No laps set yet. Be first to Victory Lane.',     de: 'Noch keine Runden gesetzt. Sei der Erste in Victory Lane.',
                               nl: 'Nog geen rondes gezet. Wees de eerste in Victory Lane.',
                               fr: 'Aucun tour encore. Soyez le premier en Victory Lane.',
                               es: 'Aún sin vueltas. Sé el primero en Victory Lane.' },
  ...
  play_brand_label:          { en: '🏁 INDY 500',                                    de: '🏁 INDY 500',                                  nl: '🏁 INDY 500',                              fr: '🏁 INDY 500',                               es: '🏁 INDY 500' },
  ...
  gate_eifel_unforgiving:    { en: 'The Brickyard is unforgiving. Grab 5 more for €2 and keep chasing Victory Lane.',
                               de: 'Der Brickyard verzeiht nichts. Hol dir 5 weitere für 2 € und jag weiter Victory Lane.',
                               nl: 'De Brickyard is meedogenloos. Pak er 5 extra voor € 2 en blijf Victory Lane najagen.',
                               fr: "Le Brickyard ne pardonne pas. Prenez 5 tours de plus pour 2 € et continuez la chasse à Victory Lane.",
                               es: 'El Brickyard no perdona. Compra 5 más por 2 € y sigue cazando Victory Lane.' },
  ...
  results_new_record:        { en: '🏁 New Indy 500 trivia record!',                 de: '🏁 Neuer Indy-500-Trivia-Rekord!',             nl: '🏁 Nieuw Indy 500-trivia-record!',          fr: '🏁 Nouveau record trivia Indy 500 !',        es: '🏁 ¡Nuevo récord de trivia Indy 500!' },
  ...
  share_message_template:    { en: '{who} just hot-lapped the Indy 500 trivia time-trial in {time}.{rank} Can you beat it?',
                               de: '{who} hat soeben das Indy-500-Trivia-Zeitfahren in {time} hingelegt.{rank} Schaffst du das besser?',
                               nl: '{who} legde net een hot lap neer in de Indy 500 trivia time-trial in {time}.{rank} Kun jij het beter?',
                               fr: '{who} vient de boucler le contre-la-montre trivia Indy 500 en {time}.{rank} Vous faites mieux ?',
                               es: '{who} acaba de hacer una vuelta rápida en la trivia Indy 500 en {time}.{rank} ¿Puedes superarla?' },
  ...
  buy_body:                  { en: 'Top up with {paid} more attempts on the Indy 500 trivia time trial. Credits activate immediately after payment and stay on this device for 30 days.',
                               de: 'Lade {paid} weitere Versuche fürs Indy-500-Trivia-Zeitfahren auf. Die Credits werden direkt nach der Zahlung aktiviert und bleiben 30 Tage auf diesem Gerät.',
                               nl: 'Vul aan met {paid} extra pogingen op de Indy 500 trivia time-trial. De credits worden direct na betaling geactiveerd en blijven 30 dagen op dit apparaat.',
                               fr: 'Rechargez {paid} essais supplémentaires sur le contre-la-montre Indy 500. Les crédits sont activés dès le paiement et restent 30 jours sur cet appareil.',
                               es: 'Recarga {paid} intentos más en la trivia Indy 500. Los créditos se activan al instante tras el pago y duran 30 días en este dispositivo.' },
  ...
  // ── Footer ──
  footer_text:               { en: 'IndyCar Time Trial · Built by Kirk & Blackbeard · Not affiliated with INDYCAR LLC or the Indianapolis Motor Speedway. Trivia is for fun.',
                               de: 'IndyCar Time Trial · Gebaut von Kirk & Blackbeard · Nicht mit INDYCAR LLC oder dem Indianapolis Motor Speedway verbunden. Trivia ist zum Spaß.',
                               nl: 'IndyCar Time Trial · Gebouwd door Kirk & Blackbeard · Niet verbonden met INDYCAR LLC of de Indianapolis Motor Speedway. Trivia is voor de fun.',
                               fr: 'IndyCar Time Trial · Créé par Kirk & Blackbeard · Non affilié à INDYCAR LLC ni à l\'Indianapolis Motor Speedway. Trivia pour le plaisir.',
                               es: 'IndyCar Time Trial · Creado por Kirk & Blackbeard · No afiliado con INDYCAR LLC ni con el Indianapolis Motor Speedway. La trivia es por diversión.' },
